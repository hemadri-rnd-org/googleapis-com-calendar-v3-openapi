...
func Calendar_calendars_patchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCalendar_calendars_patchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_calendars_calendarId",
		mcp.WithDescription("Updates metadata for a calendar. This method supports patch semantics."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_calendars_patchHandler(cfg),
	}
}
