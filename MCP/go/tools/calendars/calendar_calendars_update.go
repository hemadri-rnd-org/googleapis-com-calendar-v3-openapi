...
func Calendar_calendars_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCalendar_calendars_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_calendars_calendarId",
		mcp.WithDescription("Updates metadata for a calendar."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_calendars_updateHandler(cfg),
	}
}
