...
func Calendar_calendars_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCalendar_calendars_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_calendars_calendarId",
		mcp.WithDescription("Returns metadata for a calendar."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_calendars_getHandler(cfg),
	}
}
