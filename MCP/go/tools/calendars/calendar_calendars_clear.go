...
func Calendar_calendars_clearHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/calendars/%s/clear%s", cfg.BaseURL, calendarId, queryString)
...
func CreateCalendar_calendars_clearTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_calendars_calendarId_clear",
		mcp.WithDescription("Clears a primary calendar. This operation deletes all events associated with the primary calendar of an account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_calendars_clearHandler(cfg),
	}
}
