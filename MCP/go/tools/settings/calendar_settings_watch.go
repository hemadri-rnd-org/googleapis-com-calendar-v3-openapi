...
func Calendar_settings_watchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/me/settings/watch%s", cfg.BaseURL, queryString)
...
func CreateCalendar_settings_watchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_users_me_settings_watch",
		mcp.WithDescription("Watch for changes to Settings resources."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_settings_watchHandler(cfg),
	}
}
