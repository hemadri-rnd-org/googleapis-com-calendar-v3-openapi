...
func Calendar_acl_patchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCalendar_acl_patchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_calendars_calendarId_acl_ruleId",
		mcp.WithDescription("Updates an access control rule. This method supports patch semantics."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_acl_patchHandler(cfg),
	}
}
