...
func Calendar_acl_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/calendars/%s/acl%s", cfg.BaseURL, calendarId, queryString)
...
func CreateCalendar_acl_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_calendars_calendarId_acl",
		mcp.WithDescription("Creates an access control rule."),
		...
		mcp.WithBoolean("sendNotifications", mcp.Description("Whether to send notifications about the calendar sharing change. Optional. The default is True.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_acl_insertHandler(cfg),
	}
}
