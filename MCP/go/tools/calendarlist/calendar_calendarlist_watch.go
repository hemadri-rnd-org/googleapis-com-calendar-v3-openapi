...
func Calendar_calendarlist_watchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/me/calendarList/watch%s", cfg.BaseURL, queryString)
...
func CreateCalendar_calendarlist_watchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_users_me_calendarList_watch",
		mcp.WithDescription("Watch for changes to CalendarList resources."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_calendarlist_watchHandler(cfg),
	}
}
