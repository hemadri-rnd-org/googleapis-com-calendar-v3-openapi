...
func Calendar_channels_stopHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/channels/stop%s", cfg.BaseURL, queryString)
...
func CreateCalendar_channels_stopTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_channels_stop",
		mcp.WithDescription("Stop watching resources through this channel"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Calendar_channels_stopHandler(cfg),
	}
}
